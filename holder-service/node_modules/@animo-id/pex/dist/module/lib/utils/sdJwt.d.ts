import { SdJwtDecodedVerifiableCredential, SdJwtPresentationFrame } from '@sphereon/ssi-types';
export declare function calculateSdHash(compactSdJwtVc: string, alg: string): string;
/**
