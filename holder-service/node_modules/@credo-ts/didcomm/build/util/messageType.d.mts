...
//#region src/util/messageType.d.ts
interface ParsedDidCommProtocolUri {
  /**
...
interface ParsedMessageType extends ParsedDidCommProtocolUri {
  /**
   * Message name
   *
   * @example request
...
declare function parseDidCommProtocolUri(didCommProtocolUri: string): ParsedDidCommProtocolUri;
/**
 ...
 * const isIncomingProtocolUriSupported = supportsIncomingDidCommProtocolUri(incomingProtocolUri, expectedProtocolUri)
 */
declare function supportsIncomingDidCommProtocolUri(incomingProtocolUri: ParsedDidCommProtocolUri, expectedProtocolUri: ParsedDidCommProtocolUri, {
...
//#endregion
export { IsValidMessageType, ParsedDidCommProtocolUri, ParsedMessageType, parseDidCommProtocolUri, parseMessageType, replaceLegacyDidSovPrefix, supportsIncomingDidCommProtocolUri, supportsIncomingMessageType };
