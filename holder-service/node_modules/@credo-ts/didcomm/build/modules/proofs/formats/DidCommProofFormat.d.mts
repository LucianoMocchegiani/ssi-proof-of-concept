//#region src/modules/proofs/formats/DidCommProofFormat.d.ts
/**
 ...
 * ```
 */
type DidCommProofFormatPayload<PFs extends DidCommProofFormat[], M extends keyof DidCommProofFormat['proofFormats']> = { [ProofFormat in PFs[number] as ProofFormat['formatKey']]?: ProofFormat['proofFormats'][M] };
/**
 ...
 * ```
 */
type DidCommProofFormatCredentialForRequestPayload<PFs extends DidCommProofFormat[], M extends 'selectCredentialsForRequest' | 'getCredentialsForRequest', IO extends 'input' | 'output'> = { [DidCommProofFormat in PFs[number] as DidCommProofFormat['formatKey']]?: DidCommProofFormat['proofFormats'][M][IO] };
interface DidCommProofFormat {
  formatKey: string;
  proofFormats: {
...
//#endregion
export { DidCommProofFormat, DidCommProofFormatCredentialForRequestPayload, DidCommProofFormatPayload };
//# sourceMappingURL=DidCommProofFormat.d.mts.map