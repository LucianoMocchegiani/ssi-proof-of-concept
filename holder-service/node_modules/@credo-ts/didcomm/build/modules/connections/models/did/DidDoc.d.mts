...
import { DidCommV1Service, DidDocumentService, IndyAgentService } from "@credo-ts/core";

//#region src/modules/connections/models/did/DidDoc.d.ts
type DidDocOptions = Pick<DidDoc, 'id' | 'publicKey' | 'service' | 'authentication'>;
declare class DidDoc {
  context: string;
  id: string;
  publicKey: PublicKey[];
...
//#endregion
export { DidDoc };
//# sourceMappingURL=DidDoc.d.mts.map