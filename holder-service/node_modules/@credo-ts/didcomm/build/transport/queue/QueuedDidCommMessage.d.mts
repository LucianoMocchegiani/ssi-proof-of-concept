...
//#region src/transport/queue/QueuedDidCommMessage.d.ts
/**
 ...
 */
type QueuedDidCommMessage = {
  id: string;
  receivedAt: Date;
  encryptedMessage: DidCommEncryptedMessage;
};
//#endregion
export { QueuedDidCommMessage };
//# sourceMappingURL=QueuedDidCommMessage.d.mts.map