import { SignatureDecorator } from "./SignatureDecorator.mjs";
import { Buffer, CredoError, JsonEncoder, Kms, TypedArrayEncoder, utils } from "@credo-ts/core";

//#region src/decorators/signature/SignatureDecoratorUtils.ts
/**
...
async function unpackAndVerifySignatureDecorator(agentContext, decorator) {
	...
	if (!(await kms.verify({
		...
		signature
	})).verified) throw new CredoError("Signature is not valid");
...
//#endregion
export { signData, unpackAndVerifySignatureDecorator };
//# sourceMappingURL=SignatureDecoratorUtils.mjs.map