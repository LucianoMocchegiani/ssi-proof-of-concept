...
//#region src/modules/sd-jwt-vc/SdJwtVcModuleConfig.d.ts
type CustomTypeMetadataResolverOptions = {
  /**
   ...
   */
  defaultResolver: (options: Pick<CustomTypeMetadataResolverOptions, 'throwErrorOnFetchError' | 'throwErrorOnUnsupportedVctValue'>) => Promise<Record<string, unknown> | undefined>;
};
/**
 ...
 */
type CustomTypeMetadataResolver = (vct: string, integrity: string | undefined, options: CustomTypeMetadataResolverOptions) => Promise<SdJwtVcTypeMetadata | Record<string, unknown> | undefined>;
interface SdJwtVcModuleConfigOptions {
  /**
 ...
 * @public
 */
declare class SdJwtVcModuleConfig {
  private options;
  constructor(options?: SdJwtVcModuleConfigOptions);
  get customTypeMetadataResolver(): CustomTypeMetadataResolver | undefined;
}
//#endregion
export { SdJwtVcModuleConfig, SdJwtVcModuleConfigOptions };
//# sourceMappingURL=SdJwtVcModuleConfig.d.mts.map