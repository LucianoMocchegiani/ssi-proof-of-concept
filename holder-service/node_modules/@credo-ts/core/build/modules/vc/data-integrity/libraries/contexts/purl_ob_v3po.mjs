...
//#region src/modules/vc/data-integrity/libraries/contexts/purl_ob_v3po.ts
const PURL_OB_V3P0 = { "@context": {
	id: "@id",
	type: "@type",
	xsd: "https://www.w3.org/2001/XMLSchema#",
	OpenBadgeCredential: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#OpenBadgeCredential" },
	Achievement: {
		...
		"@context": {
			...
			creator: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#Profile" },
			creditsAvailable: {
	...
	AchievementSubject: {
		...
		"@context": {
			achievement: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#Achievement" },
			activityEndDate: {
	...
	Address: {
		...
		"@context": {
			...
			geo: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#GeoCoordinates" },
			postOfficeBoxNumber: {
	...
	Criteria: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#Criteria" },
	EndorsementCredential: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#EndorsementCredential" },
	EndorsementSubject: {
		"@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#EndorsementSubject",
		"@context": { endorsementComment: {
	...
	Profile: {
		...
		"@context": {
			...
			address: { "@id": "https://purl.imsglobal.org/spec/vc/ob/vocab.html#Address" },
			dateOfBirth: {
...
//#endregion
export { PURL_OB_V3P0 };
//# sourceMappingURL=purl_ob_v3po.mjs.map